...
var AwesomeProject = React.createClass({
    render: function() {
        return (
            <View style={{}}>
                <View style={[styles.height200, styles.row,]}>

                  <View style={[styles.height200, styles.part_1_left, {borderColor:'#DDD8CE', borderBottomWidth:1},]}>
                  ...
                  <Image style={[styles.yue, styles.marTop14]} source={{uri: 'http://p0.meituan.net/mmc/fe4d2e89827aa829e12e2557ded363a112289.png'}}></Image>
                  </View>
                  
                  <View style={[styles.height200, styles.part_1_right,]}>

                    <View style={[styles.row, {flex:1}]}>
                      <View style={{flex:1}}>
                      <Text style={[styles.font14, {marginLeft:30}, styles.red]}>超低价格</Text>
                    ...
                    <View style={[{flex:1, flexDirection: 'row',borderTopWidth:0.5, borderColor:'#DDD8CE'}]}>
                      <View style={{flex:1, borderRightWidth:0.5, borderColor:'#DDD8CE',}}>
                      ...
                      <Image style={{height:30,width:30, alignSelf: 'center'}} source={{uri: 'http://p1.meituan.net/mmc/08615b8ae15d03c44cc5eb9bda381cb212714.png'}}></Image>
                      </View>
                      <View style={{flex:1,}}>
